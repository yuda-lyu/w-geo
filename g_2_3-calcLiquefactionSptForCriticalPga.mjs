...
function calc(k) {
    ...
    let resOut = calcLiquefactionSptForCriticalPga(rowsIn, methods, opt)
    // console.log('resOut',resOut)

    fs.writeFileSync(`./calcLiquefactionSptForCriticalPga-rowsIn${k}.json`, JSON.stringify(rowsIn, null, 2), 'utf8')
    fs.writeFileSync(`./calcLiquefactionSptForCriticalPga-resOut${k}.json`, JSON.stringify(resOut, null, 2), 'utf8')
...
//node --experimental-modules g_2_3-calcLiquefactionSptForCriticalPga.mjs
