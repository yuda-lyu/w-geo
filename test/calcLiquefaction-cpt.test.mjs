...
import rowsIn1 from './calcLiquefaction-cpt-rowsIn1.json'
import rowsOut1 from './calcLiquefaction-cpt-rowsOut1.json'
import rowsIn2 from './calcLiquefaction-cpt-rowsIn2.json'
import rowsOut2 from './calcLiquefaction-cpt-rowsOut2.json'
