...
describe(`dtIntrpPsdContentUscs`, function() {
    ...
    it(`should return ${JSON.stringify(rr1)} when dtIntrpPsdContentUscs(${JSON.stringify(r1)})`, function() {
        let r = dtIntrpPsdContentUscs(r1)
        let rr = rr1
